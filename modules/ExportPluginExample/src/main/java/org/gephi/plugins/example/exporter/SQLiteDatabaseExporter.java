 ...
 * <p>
 * File exporters are normally implementing {@link ByteExporter} or
 * {@link CharacterExporter} and write to a {@link Writer} or
 * {@link InputStream}. In this case that won't work because the SQLite driver
 * manages the file writing by itself so we simply have to execute UPDATE
 * queries.
 * <p>
