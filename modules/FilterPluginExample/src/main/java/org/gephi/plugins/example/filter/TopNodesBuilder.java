 ...
 * <p>
 * This example shows how to create <code>CategoryBuilder</code>
 * implementations, which are used for attributes-based filters. Category
 * builders are one level above <code>FilterBuilder</code> implementations.
 * Indeed, category builders create filter builders. For filters which work on
 * attribute columns (e.g. name, age, gender etc.) a category builder builds one
 * <code>FilterBuilder</code> per column.
 * <p>
 * The created <code>TopNodesColumnFilterBuilder</code> builders store the
 * column they are assigned and pass it on to the created filters.
 * <p>
...
public class TopNodesBuilder implements CategoryBuilder {
    ...
    /**
     * Inner class for the Filter builder. One of those is created for each
     * columns.
     */
    private static class TopNodesColumnFilterBuilder implements FilterBuilder {
        ...
        public TopNodesColumnFilterBuilder(Column column) {
            this.column = column;
        }
        ...
        public String getName() {
            ...
            return "<font color='#000000'>" + column.getTitle() + "</font> "
                    + "<font color='#999999'><i>" + column.getTypeClass().toString() + " "
                    + "(Node)</i></font>";
        }
