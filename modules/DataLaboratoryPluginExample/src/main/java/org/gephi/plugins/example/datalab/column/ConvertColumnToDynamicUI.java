...
/**
 * UI for ConvertColumnToDynamic Demonstrates Netbeans Validation API
 *
...
public class ConvertColumnToDynamicUI extends javax.swing.JPanel implements AttributeColumnsManipulatorUI {
    ...
    @Override
    public void setup(AttributeColumnsManipulator m, GraphModel model, Table table, Column column, DialogControls dialogControls) {
