...
/**
 * General action that inverts the current table row selection. Note that we
 * implement PluginGeneralActionsManipulator instead of
 * GeneralActionsManipulator in order to specify that this action has to appear
 * in the 'More actions' dialog to not fill the toolbar.
 *
