 ...
 * is useful when a plug-in requires multiple parameters and/or complex
 * components.
 * <p>
 * For each implementation of <code>PreviewUI</code> a new tab is added to the
 * preview settings module with the panel provided by the
 * <code>getPanel()</code> method.
 * <p>
 * In this case we populate the panel with a combob box for choosing an
 * attribute column.
 *
